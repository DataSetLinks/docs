...
description: "This documentation provides a reference for constructing queries in the ontology graph engine. Queries allow you to search, filter, group, and process data stored in interconnected schemas."
---
