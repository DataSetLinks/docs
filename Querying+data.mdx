...
3 - The query you want to run. The reason why this curl is a Post is so you can send the query on the body. Our query language keeps growing and soon we'll publish documentation for the whole feature space, as such, for the time-being you can find the following examples:
