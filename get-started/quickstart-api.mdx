...
The unstructured data file you’ll use is a simple text file created by copying and pasting a list of dental society members into a text file.  This is the  `society_members_api.txt`file you downloaded in the Prerequisites section.
