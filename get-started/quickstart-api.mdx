...
This guide shows you how to use DataLinks web platform and SDK kit to find shared opportunities across two North American data sources. You will learn by doing: uploading files, connecting records, and exploring the results directly in the platform.
...
- A dental society member list that includes dentists and clinic owners across the United States and Canada — society_list_api.txt
...
The unstructured data file you’ll use is a simple text file created by copying and pasting the list of society members directly from the [Deutsche Gesellschaft für Orale Implantologie (DGOI) website](https://www.dgoi.info/die-dgoi/mitglieder). This is the `society_member.txt`file.
...
1. Add the following information to the file:
   ...
   - On line 27, enter the namespace you're using (`dental_prospects`)
   - On line 28, enter the name for the new dataset you're creating (`society_members`)
   - On line 34, update the location of the `society_members_api.txt` based on where you've placed the file.
