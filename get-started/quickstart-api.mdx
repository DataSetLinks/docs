...
The unstructured data file you’ll use is a simple text file created by copying and pasting a list of dental society members into a text file. This is the  `society_members_api.txt`file you downloaded `quickstart_api.zip` folder you downlaoded in the Prerequisites section.
...
1. Add the following information to the file:
   ...
   - On line 34, if needed, update the location of the `society_members_api.txt` based on where you've placed the file.
