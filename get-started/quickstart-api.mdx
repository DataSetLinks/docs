...
4. The DataLinks SDK installed on your machine.
   ...
   <Note>
     For installation instructions, see the official [DataLinks SDK Installation Steps](https://docs.datalinks.com/pythonsdk/sdk-install).
   </Note>
...
1. Click the **customer_list** dataset in the `dental_prospects_api` namespace.
...
2. Ensure the namespace selector in the top-right corner of your screen is set to **dental_prospects_api**.
