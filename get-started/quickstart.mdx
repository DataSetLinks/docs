...
## Part 3: Create a second dataset and upload the unstructured data

Now that you have your customer list uploaded, you need to upload 

## Part 4: Query your data to create a list of sales prospects
