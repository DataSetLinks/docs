...
3. In the **Helper Prompt** field, past the following: `This is the data from a dental societies where the names of members (dental practices), the addresses, the phone numbers, and the websites, are included. The file contains several entries. `
