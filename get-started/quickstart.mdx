...
2. Click the **customer_list** dataset in the `dental_prospects_web` namespace.
...
Once your data is connected, you are ready to explore it in DataLinks and turn it into meaningful insights. In this example, you will identify customers from your`customer_list `who are also members of the professional society you want to target.

Follow these steps to run your first query:

1. Click **Connections Overview** in the left menu.
2. Ensure the namespace selector in the top-right corner of your screen is set to **dental_prospects_web**.
3. Click the **left arrow icon** to expand the chat window.
3. In the chatbox, submit a prompt such as: `Find people associated with my customer Andrew Williams, and let me know why I should engage with them.`

After reviewing the response, experiment with your own questions. The DataLinks chatbot uses your connected data to generate contextual, well-reasoned answers that help you uncover new opportunities.

## Next steps

Congratulations! You've used structured and unstructured data to find a list of prospects and query your data.
