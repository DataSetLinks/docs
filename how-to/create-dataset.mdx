...
Follow these steps:
    ...
    <Frame>
      <video className="block mx-auto" src="https://res.cloudinary.com/dlq2nawz5/video/upload/f_auto,q_auto/v1765784512/share-project_gpldrd.mp4" alt="Screen capture of creating a dataset in the DataLinks web platform." controls autoPlay muted loop />
    </Frame>
