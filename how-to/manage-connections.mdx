...
## View all connections in the Connections Overview

The Connections Overview provides a top-level visualization of your knowledge map, helping you see how information flows across datasets. Public datasets will appear only if there is at least one shared or matching entity between your data and theirs.

To see the full picture of how your datasets connect:

1. Log in to your DataLinks account.
2. In the left navigation menu, click **Connections Overview**.
