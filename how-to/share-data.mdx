...
By default every dataset you create is private and visible only to you. When you want a teammate to [query your data](/how-to/query-data), or help maintain it, you can share access with them directly. 
