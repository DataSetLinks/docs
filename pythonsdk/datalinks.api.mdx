...
* **Returns:**
  The created link object, or None on failure.
* **Return type:**
  Optional[Dict]
* **Raises:**
  [**DataLinksRequestError**](#datalinks.api.DataLinksRequestError) – If the HTTP request fails.
...
### *class* datalinks.api.PipelineRun(run_id, response)

Bases: `object`

Wraps a streaming pipeline response.
...
### *class* datalinks.api.ingest_proxy.PipelineRun(run_id, response)
