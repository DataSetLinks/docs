...
This guide walks you through how to connect two data sources in Datalinks to uncover new sales opportunities using existing relationships. As you follow the steps, you’ll learn how to create namespaces and datasets, work with the SDK, and use the Datalinks web platform to transform unstructured data into an actionable list of prospects.

**Scenario**

Let’s say you work in dental sales and want to reach new clinics or partners. Instead of relying on cold outreach, you’d like to find out which of your existing customers are already connected to key members of the dental community who are members of the _Deutsche Gesellschaft für Orale Implantologie_ (DGOI). 
