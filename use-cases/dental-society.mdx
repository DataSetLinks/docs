...
This guide walks you through how to connect two data sources in Datalinks to uncover new sales opportunities using the relationships you already have. As you follow the steps, you’ll learn how to create namespaces and datasets, work with the SDK, and use the Datalinks web platform to transform unstructured data into meaningful sales insights.

### Scenario

Let’s say you work in dental sales and want to reach new clinics or partners. Instead of relying on cold outreach, you’d like to find out which of your existing customers are already connected to key members of the dental community.

In this exercise, you’ll upload a structured customer list, extract member details from a public dental society website, and link the two datasets. The result will reveal which of your current customers are also society members, showing you who might naturally introduce you to new contacts or business opportunities within their professional network.

### Outcome

By the end of this guide, you’ll have a table listing all customers who are also members of the dental society. You can view this list directly in Datalinks or export it as a CSV file for your records.

## Prerequisites

To follow along on your machine and execute the steps in the guide, you’ll need a few things first:

1. To download a copy of this guide's [example script and data files](#).
2. A Datalinks account you can log into to obtain an API token. 
...
4. The Datalinks SDK installed on your machine. To install, use the following command: `pip install datalinks`.
5. A code editor to work in, such as Microsoft Visual Studio Code, which is [free to download on Windows, Linux, or Mac](https://code.visualstudio.com/download).
