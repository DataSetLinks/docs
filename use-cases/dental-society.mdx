...
Let’s say you work in dental sales and want to reach new clinics or partners. Instead of relying on cold outreach, you’d like to find out which of your existing customers are already connected to key members of the dental community who are members of the _Deutsche Gesellschaft für Orale Implantologie_ (DGOI), which translates to the _German Society for Oral Implantology_.

In this exercise, you’ll upload a structured customer list, extract member details from a public DGOI website, and link the two datasets. The result will reveal which of your current customers are also society members, showing you who might naturally introduce you to new contacts or business opportunities within their professional network.

**Outcome**

By the end of this guide, you’ll have a table listing all of your existing customers who are also DGOI members. You can view this list directly in the Datalinks web platform or export it as a CSV file.
...
The unstructured data file you’ll use is a simple text file created by copying and pasting the list of society members directly from the [Deutsche Gesellschaft für Orale Implantologie (DGOI) website](https://www.dgoi.info/die-dgoi/mitglieder). This is the 
